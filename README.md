...
> This is a javascript project made to create a restaurant homepage by dynamically rendering it using JavaScript DOM manipulation. JavaScript is used to generate the entire contents of the website. Bootstrap and CSS rules are applied for a better UI and UX. 
